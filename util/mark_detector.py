...
class FaceDetector:
    ...
    def __init__(self,
                 dnn_proto_text='pose_estimate_assets/deploy.prototxt',
                 dnn_model='pose_estimate_assets/res10_300x300_ssd_iter_140000.caffemodel'):
        """Initialization"""
...
class MarkDetector:
    ...
    def __init__(self, saved_model='pose_estimate_assets/pose_model'):
        """Initialization"""
